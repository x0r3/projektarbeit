...
vm.com_dukescript_demoapp_js_$JsCallbacks$ = function com_dukescript_demoapp_js_$JsCallbacks$() {
  var m;
  var CLS = com_dukescript_demoapp_js_$JsCallbacks$;
  if (!CLS.$class) {
  ...
  m = c._p = function (v) {  if (arguments.length == 1) this.fld_com_dukescript_demoapp_js_$JsCallbacks$_p = v; return this.fld_com_dukescript_demoapp_js_$JsCallbacks$_p; };
  m = c._last = function (v) {  if (arguments.length == 1) this.fld_com_dukescript_demoapp_js_$JsCallbacks$_last = v; return this.fld_com_dukescript_demoapp_js_$JsCallbacks$_last; };
...
return;
    ...
    m.access = 2;
    m.cls = CLS;
    m = c.current__Lcom_dukescript_demoapp_js_$JsCallbacks$_2 = function() {
  var  lcA0 = this;
...
var stA0 = lcA0;var stA1 = new vm.com_dukescript_demoapp_js_$JsCallbacks$;
...
var stA0 = new vm.com_dukescript_demoapp_js_$JsCallbacks$;
...
return;
    ...
    m.cls = CLS;
    c.constructor = CLS;
    function com_dukescript_demoapp_js_$JsCallbacks$fillInstOf(x) {
        Object.defineProperty(x, '$instOf_com_dukescript_demoapp_js_$JsCallbacks$', { value : true });
    }
    if (!c.hasOwnProperty('fillInstOf')) Object.defineProperty(c, 'fillInstOf', { value: com_dukescript_demoapp_js_$JsCallbacks$fillInstOf });
    com_dukescript_demoapp_js_$JsCallbacks$fillInstOf(c);
    CLS.$class = 'temp';
    CLS.$class = vm.java_lang_Class(true);
    CLS.$class.jvmName = 'com/dukescript/demoapp/js/$JsCallbacks$';
  ...
  if (arguments.length === 0) {
    ...
    this.fld_com_dukescript_demoapp_js_$JsCallbacks$_p = null;
    this.fld_com_dukescript_demoapp_js_$JsCallbacks$_last = null;
    return this;
  }
  return arguments[0] ? new CLS() : CLS.prototype;
};
exports['com_dukescript_demoapp_js_$JsCallbacks$'] = vm.com_dukescript_demoapp_js_$JsCallbacks$;
...
vm.com_dukescript_demoapp_js_Dialogs = function com_dukescript_demoapp_js_Dialogs() {
  var m;
  var CLS = com_dukescript_demoapp_js_Dialogs;
  if (!CLS.$class) {
    var pp = vm.java_lang_Object(true);
    var p = CLS.prototype = pp;
    var c = p;
...
return;
  ...
  vm.com_dukescript_demoapp_js_$JsCallbacks$(false)._VM().java_1lang_1Runnable$run$__Ljava_lang_Object_2Ljava_lang_Runnable_2(callback);
}
...
c['getHeightOfElement__ILjava_lang_String_2'] = m;
    ...
    m.cls = CLS;
    c.constructor = CLS;
    function com_dukescript_demoapp_js_DialogsfillInstOf(x) {
        Object.defineProperty(x, '$instOf_com_dukescript_demoapp_js_Dialogs', { value : true });
    }
    if (!c.hasOwnProperty('fillInstOf')) Object.defineProperty(c, 'fillInstOf', { value: com_dukescript_demoapp_js_DialogsfillInstOf });
    com_dukescript_demoapp_js_DialogsfillInstOf(c);
    CLS.$class = 'temp';
    CLS.$class = vm.java_lang_Class(true);
    CLS.$class.jvmName = 'com/dukescript/demoapp/js/Dialogs';
    CLS.$class.superclass = sprcls;
    CLS.$class.interfaces = function() { return [
    ]; };
    CLS.$class.access = 49;
...
exports['com_dukescript_demoapp_js_Dialogs'] = vm.com_dukescript_demoapp_js_Dialogs;
